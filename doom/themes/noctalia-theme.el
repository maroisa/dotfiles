...
(let* ((bg "#1f1f28")
      ...
      (outline-color "#63635f")
      (outline-variant "#2f2f2d")
      (primary "#76946a")
      (primary-container "#436038")
      (secondary "#c0a36e")
      (secondary-container "#725827")
      (shadow "#000000")
      (surface "#1f1f28")
      (surface-container "#2c2c39")
      (surface-container-high "#333342")
      (surface-container-highest "#3a3a4a")
      (surface-container-low "#262631")
      (surface-container-lowest "#1f1f28")
      (surface-variant "#2a2a36")
      (tertiary "#7e9cd8")
      (tertiary-container "#1c3c7d")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#7e9cd8")
      (on-success "#e6e1e5")
      (success-container "#1c3c7d")
      (on-success-container "#ffffff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#76946a")
      (primary-fixed-dim "#436038")
      (secondary-fixed "#c0a36e")
      (secondary-fixed-dim "#725827")
      (tertiary-fixed "#7e9cd8")
      (tertiary-fixed-dim "#1c3c7d")
      ...
      (inverse-primary "#76946a")
      (inverse-surface "#1f1f28")
